...
```
Эта команда возвращает список действий, настроенных для клиентов в вашей системе FusionPOS. Если результат — пустой список `[]`, это означает, что в системе не настроено никаких специальных действий.
